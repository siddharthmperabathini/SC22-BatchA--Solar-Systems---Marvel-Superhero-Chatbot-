...
function chatbotIronmanResponse() {
  talking = true;
  botMessage = {{ generated }};
...
function newEntry() {
  ...
  if (document.getElementById("chatbox").value != "") {
    ...
    setCookie("ironmanAICAMP", getCookie("ironmanAICAMP")+"^^You :"+lastUSerMessage)
...
$(document).ready(function() {
  ...
  cookie = getCookie(ironmanCookieAICAMP);
